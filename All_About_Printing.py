print("hello world")
print("My name is Debmalya Chaki")


# For Single Line Comments

# for multiline use ctrl + / for windows and command + / for mac
...
# Print A writing about python laguage in 10000 words 
...
Pro tip
Looking for the best tools to kick-start your web application project? Hostinger's AI-powered web app maker offers an innovative, no-code solution to bring your ideas to life!
...
Example of a visualization created with Python's Matplotlib library
